		...
		<div id="aboutDiv">
			<Navi />
				<div className="container">
					...
					<p id="bio826">
						I took a placement test for college entry today. I've been accepted into an Associate's degree program in Information Technology with a specialization in Cyber Security.
					</p>
