			...
			<Navi />
				<div className="container">
					...
					<p id="bio826">
						...
						<p className="textIndent">I've been accepted into an Associate's degree program in Information Technology with a specialization in Cyber Security.
					</p>
